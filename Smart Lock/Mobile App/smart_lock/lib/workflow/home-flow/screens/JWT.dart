...
class HomeDynamic2 extends StatefulWidget {
  const HomeDynamic2({Key? key}) : super(key: key);

  @override
  State<HomeDynamic2> createState() => _HomeDynamicState2();
}

class _HomeDynamicState2 extends State<HomeDynamic2> {
  var UniqueCode = '0x01';
